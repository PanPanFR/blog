...
import { TableOfContentsClient as TableOfContents } from "@/components/client/toc-client";
import { MobileTableOfContentsClient as MobileTableOfContents } from "@/components/client/toc-client";
import { PromoContentClient as PromoContent } from "@/components/client/promo-client";
...
export async function generateStaticParams() {
  const allPages = blogSource.getPages() as { url: string }[];
          ...
          {page.data.thumbnail && (
            <div className="relative w-full h-[500px] overflow-hidden object-cover border border-transparent">
              <Image
                ...
                priority
                placeholder="blur"
                blurDataURL="data:image/svg+xml;base64,"
              />
            </div>
          )}
